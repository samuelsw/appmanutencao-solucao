...
uses
  ...
  public
    ...
    function SalvarArquivos(AData: OleVariant; fileNumber :integer = 0): Boolean;
  end;
      ...
      begin
        try
          ...
          begin
            ...
            cds := InitDataset;
            cds.Append;
            TBlobField(cds.FieldByName('Arquivo')).LoadFromFile(FPathOrigem + '/pdf.pdf');
            cds.Post;
           ...
           raise EThreadCopyFiles.Create('Falha ao copiar arquivos para o servidor.');
        end;
...
function TServidor.SalvarArquivos(AData: OleVariant; fileNumber :integer): Boolean;
var
  cds: TClientDataSet;
  FileName: string;
begin
